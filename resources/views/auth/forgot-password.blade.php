        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="text-center">
                    ...
                    Vous avez oublié votre mot de passe? Entrez juste votre adreese Email
                    et nous vous enverons un mail contenant le lien de réinitialisation du
                    mot de passe et vous allez en crrer un nouveau
                </div>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('password.confirm') }}">
                    ...
                    <div class="input-group mb-3">
                        <input name="email" id="exampleEmail" placeholder="Email" type="email" :value="old('email')"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block">Envoyer le mail</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
